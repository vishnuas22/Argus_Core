...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 [box-shadow:inset_0_1px_0_0_hsl(0_0%_100%_/_0.08)]",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/80 [box-shadow:inset_0_1px_0_0_hsl(0_0%_100%_/_0.08)]",
        outline:
          "border border-border bg-background shadow-sm hover:bg-muted hover:text-foreground [box-shadow:inset_0_1px_0_0_hsl(var(--foreground)_/_0.03)]",
        secondary:
