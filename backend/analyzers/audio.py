...
class AudioAnalyzer(BaseAnalyzer):
    ...
    def extract_mfcc(
        ...
        try:
            ...
            logger.warning(f"librosa MFCC failed ({e}), using simplified MFCC")
            # Return placeholder
    ...
    async def _run_aasist(
        ...
        try:
            ...
            return 0.5, {"bonafide": 0.5, "spoof": 0.5}
    ...
    async def _load_audio(
        ...
        try:
            ...
            # Audio is stored as raw float32 bytes (not .npy format despite the extension)
            # The preprocessing uses waveform.tobytes() which produces raw bytes
