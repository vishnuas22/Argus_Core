...
def create_dataloader(
    ...
    transform: Optional[Callable] = None,
    audio_transform: Optional[Callable] = None,
    use_degradation_curriculum: bool = True,
    ...
    Args:
        ...
        use_degradation_curriculum: Enable NTIRE-style degradation curriculum
        curriculum_epochs: Total epochs for degradation severity schedule

    Returns:
        DataLoader instance
    """
    if transform is None and use_degradation_curriculum and split == "train":
        from training.augmentation import DegradationPipeline
