...
MODEL_CONFIGS: Dict[str, ModelDownloadConfig] = {
    ...
    # ============== IMAGE MODELS ==============
    "ai_real_detector": ModelDownloadConfig(
        name="ai_real_detector",
        hf_model_id="capcheck/ai-human-generated-image-detection",
        model_type="image",
        task="classification",
        output_path="/models/ai_real_detector",
        input_shapes={
        ...
        num_classes=2,
        class_labels=["human", "ai_generated"],
        description="ViT-Base model for AI-vs-human image classification with modern generator coverage",
        license="Apache-2.0",
