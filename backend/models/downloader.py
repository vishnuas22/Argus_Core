...
MODEL_SOURCES: Dict[str, ModelSource] = {
    ...
    "xclip_temporal": ModelSource(
        ...
        size_mb=600,
        requires_gpu=True,
        cpu_alternative="ai_real_detector",  # Use AI detector as fallback
        export_onnx=True,
    ...
    "ai_real_detector": ModelSource(
        ...
        huggingface_repo="capcheck/ai-human-generated-image-detection",
...
class ModelDownloader:
    ...
    async def download_essential_models(self) -> Dict[str, Path]:
        ...
        """
        essential_models = [
            "ai_real_detector",  # Unified AI/Real image detection model (PyTorch)
            "clip_vit_b16",
            "retinaface",
        ]
